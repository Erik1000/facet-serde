...
## Interoperability with facet-json

JSON produced by `facet-serde` (via serde_json) can be deserialized by
`facet-json`, and vice versa. The integration test suite verifies
